...
class Request(object):
    ...
    @property
    def cookies(self, name, default=None):
        """
...
class Response(object):
    ...
    def content_length(self, value):
        ...
        '8192'
        """
        self.header('CONTENT-LENGTH', str(value))
...
def _default_error_handler(e, start_response, is_debug):
    ...
    if is_debug:
        return _debug()
    return ('<html><body><h1>500 Internal Server Error</h1><h3>%s</3h></body></html>' % str(e))
...
def _build_pattern_fn(pattern):
    ...
    if m:
        return lambda p: p.endswidth(m.group(1))
